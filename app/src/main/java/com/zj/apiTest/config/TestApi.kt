...
object TestApi {
    ...
    private inline fun <reified T : Any> getDefaultApi(baseUrl: UrlProvider = Constance.getBaseUrl(), header: HeaderProvider = Constance.getHeader(), timeOut: Long = 5000): BaseApi<T> {
