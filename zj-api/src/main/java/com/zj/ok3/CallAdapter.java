 ...
 * ZHttpServiceCreator.Builder#addCallAdapterFactory(Factory) installed} into the {@link ZHttpServiceCreator} instance.
 */
public interface CallAdapter<R, T> {
     ...
     * ZHttpServiceCreator#create(Class, MethodHandler)} (Class) the service interface} methods.
     */
