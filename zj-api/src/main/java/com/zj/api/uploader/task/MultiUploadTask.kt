...
import com.zj.api.uploader.MultiUploadBuilder
...
class MultiUploadTask internal constructor(private val builder: MultiUploadBuilder, private val observer: FileUploadListener) : ProgressListener {
