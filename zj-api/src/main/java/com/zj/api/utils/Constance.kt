...
internal object Constance {
    ...
    private fun parseOrCreateHttpExceptionByCall(e: Throwable? = null, code: Int = 400, call: Call<*>): HttpException {
        return if (e is HttpException) e else {
    ...
    fun parseOrCreateHttpException(url: String?, header: Map<String, String>?, throwable: Throwable?, codeDefault: Int = 400): HttpException {
    ...
    fun <F> dealErrorWithEH(eh: ErrorHandler?, code: Int, call: Call<F?>, e: Throwable, done: (HttpException, Any?) -> Unit) {
